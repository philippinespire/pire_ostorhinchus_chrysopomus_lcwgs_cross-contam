...
- [tissue_subsampling_admixture_heatmap.png](tissue_subsampling_admixture_heatmap.png): heatmap of K2–K4 proportions by individual, faceted by era and location.
...
- [tissue_subsampling_admixture_heatmap.png](tissue_subsampling_admixture_heatmap.png) helps visualize whether admixture patterns align with location/era structure (biological signal) versus scattered, isolated changes that could reflect contamination.
- [tissue_subsampling_k4_heatmap.png](tissue_subsampling_k4_heatmap.png) isolates K4 patterns to highlight potential mixing specific to that cluster.
